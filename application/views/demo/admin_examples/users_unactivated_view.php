...
<head>
	<meta charset="utf-8">
	<title><?php echo lang("inactivated_user_demo"); ?> | Flexi Auth | <?php echo lang("a_user_authentication_library"); ?></title>
	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
			<div class="col100">
				...
				<p>The page demonstrates a function used to return all accounts that have not been activated within 31 days since registration. All accounts listed can then optionally be deleted.</p>
			</div>		
		</div>
	</div>
						...
						<tbody>
							<tr>
								<td colspan="5" class="highlight_red">
									<?php echo lang("no_inactivated_accounts"); ?>.
								</td>
							</tr>
						</tbody>
					<?php } ?>
