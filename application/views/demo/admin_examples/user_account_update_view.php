...
<div id="body_wrap">
	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
			<div class="col100">
				...
				<p>This page is similar to the page used by users updating their own account details, but has the additional option for the administrator to update the users user group.</p>
			</div>		
		</div>
	</div>
	...
	<div class="content_wrap main_content_bg">
		<div class="content clearfix">
			<div class="col100">
				<h2><?php echo lang("update_account_for"); ?> : <?php echo $user['upro_first_name'].' '.$user['upro_last_name']; ?></h2>
