...
class Auth_model extends CI_Model {
	...
	function register_account($instant_activate = FALSE, $user_group = FALSE, $redirect = TRUE)
	{
		...
		// Set validation rules.
		// The custom rules 'identity_available' and 'validate_password' can be found in '../libraries/MY_Form_validation.php'.
		...
		if ($this->form_validation->run())
		{
			...
			if ($response)
			{
				...
				// This is an example of how to log the user into their account immediately after registering.
